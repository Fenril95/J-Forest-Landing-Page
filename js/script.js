var socialMedia = {
  ...
  twitter: 'http://youtube.com/watch?v=tvEQQFOq4ls',
  instagram: 'http://youtube.com/watch?v=tvEQQFOq4ls'
};

var socialList = function() {
  var output = '<div class="links">',
  myList = document.querySelectorAll('.links');

  for (var key in arguments[0]) {
    output += '<a href="' + socialMedia[key] + '">' +
